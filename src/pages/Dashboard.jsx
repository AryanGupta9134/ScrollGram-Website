    ...
    <div className="h-screen flex bg-gray-900 text-gray-100">
      ...
      <div className="w-2/10 bg-gray-900 border-r border-gray-800 h-full flex flex-col justify-between py-8">
        ...
        <div className="flex flex-col items-center justify-center w-full ">
          ...
          <button
            className=" p-4 text-lg text-left rounded-lg flex items-center justify-center gap-3 text-white
                       hover:bg-gray-800 hover:text-[#4DF2C0] w-full"
          >
            <RiShoppingBag2Fill />
            Products
          </button>
          <button
            className="p-4 text-lg text-left rounded-lg flex items-center justify-center gap-3
                       transition-all duration-200 hover:bg-gray-800 hover:text-[#4DF2C0] w-full"
          >
            <FaHeart />
            Liked
          </button>
          ...
          {/* Active state for current page (Products) */}
        ...
        <div className="relative group px-4">
          ...
          >
            <button
              ...
              className="flex w-full items-center justify-center gap-3 px-4 py-3 
                         text-red-400 rounded-t-xl hover:bg-gray-700 transition-colors"
            >
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 px-4 py-3 
                         rounded-b-xl hover:bg-gray-700 hover:text-[#4DF2C0] transition-colors"
            >
          ...
          <div
            className="w-full p-4 rounded-lg flex items-center justify-center gap-3 
                       ...
                       hover:bg-gray-800 hover:text-[#4DF2C0]"
          >
      ...
      <div className="w-8/10 h-screen flex flex-col">
        {/* Profile Edit Overlay (covers entire right side) */}
        {editOn && (
...
"
            >
              <option value="All" className="textr">
                -- Category --
              </option>
          ...
          <div>
            <button
              className="flex items-center gap-2 px-5 py-2.5 bg-gray-800 border border-gray-700 rounded-full 
